...
namespace letsjump\easyAjax\gii\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    /**
     * @var bool enable CRUD in a modal
     */
    public $enableEasyAjax = true;
    /**
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['enableI18N', 'enablePjax', 'enableEasyAjax'], 'boolean'],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'enableEasyAjax' => 'Enable Easy Ajax Modal',
        ]);
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'enableEasyAjax' => 'This enable CRUD functions in a bootstrap modal, by using the EasyAjax widget. Please note that the below flag <code>Enable Pjax</code> has to be true'
        ]);
    }
