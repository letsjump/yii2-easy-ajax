...
class ActionColumn extends \yii\grid\ActionColumn
{
    ...
    protected function getDefaultOptions()
    {
        if (empty($this->_defaultOptions)) {
            ...
            if ($this->modal == true) {
                $this->_defaultOptions['update']['data-ajax'] = 1;
                $this->_defaultOptions['update']['action']    = 'modal';
                $this->_defaultOptions['delete']['data-ajax'] = 1;
                $this->_defaultOptions['delete']['data-yea-method'] = 'post';
                $this->_defaultOptions['delete']['data-yea-confirm'] = Yii::t('yii', 'Are you sure you want to delete this item?');
                //$this->_defaultOptions['delete']['action']    = 'delete';
            }
    ...
    protected function headerWidth()
    {
        ...
        } elseif ( ! strstr($this->headerOptions['style'], 'width:')) {
